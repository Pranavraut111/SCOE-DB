...
const StudentEntryForm = ({ onStudentAdded }: StudentEntryFormProps) => {
  ...
  const validateForm = (): boolean => {
    ...
    const required = ['firstName', 'middleName', 'lastName', 'address', 'gender', 'category', 'dateOfBirth', 'phoneNumber', 'branch', 'year', 'motherName', 'currentSemester', 'admissionYear'];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const studentData: StudentCreate = {
        ...
        current_semester: parseInt(formData.currentSemester) || 1, // Add current semester with fallback
        admission_year: parseInt(formData.admissionYear) || 2024, // Use form admission year or default
        ...
        country: 'India',
        postal_code: ''
        // institutional_email will be auto-generated by backend
      };
      ...
      const student: Student = {
        ...
        roll_number: rollNumber,
        institutional_email: '', // Will be populated by backend
        department: formData.branch,
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  required
                >
                  <SelectTrigger className={fieldErrors.currentSemester ? 'border-destructive' : ''}>
                ...
                {fieldErrors.currentSemester && (
                  <p className="text-xs text-destructive mt-1">{fieldErrors.currentSemester}</p>
                )}
              </div>
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  required
                >
                  <SelectTrigger className={fieldErrors.admissionYear ? 'border-destructive' : ''}>
                ...
                {fieldErrors.admissionYear && (
                  <p className="text-xs text-destructive mt-1">{fieldErrors.admissionYear}</p>
                )}
              </div>
